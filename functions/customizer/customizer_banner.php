...
function elitepress_banner_page_customizer( $wp_customize ){
	...
	$wp_customize->add_section( 'portfolio_category_banner' , array(
		'title'      => __('Portfolio category', 'elitepress'),
		'panel'  => 'banner_page',
   	) );
	
	// Banner Configuration For portfolio category Template
	$wp_customize->add_setting(
    'elitepress_lite_options[banner_title_portfolio_category]',
    array(
        'default' => __('Title','elitepress'),
		'sanitize_callback' => 'sanitize_text_field',
		'type' => 'option',
    ...
    array(
        'label' => __('Title','elitepress'),
        'section' => 'portfolio_category_banner',
        'type' => 'text',
    )
	);
	...
	$wp_customize->add_setting(
    'elitepress_lite_options[banner_desc_portfolio_category]',
    array(
        'default' => ' Autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et dolore feugait.',
		'sanitize_callback' => 'sanitize_text_field',
		'type' => 'option',
