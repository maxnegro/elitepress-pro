...
// Creating the widget
			...
			<div class="contact-area">
				<div class="media">
					...
					<div class="media-body">
						...
						<?php } else { ?> 
						<h4><?php echo __("500 North Side Boulevard, San Francisco, CA, USA","elitepress"); ?></h4>
						<?php } ?>
	...
	$title = __( '500 North Side Boulevard, San Francisco, CA, USA,', 'elitepress' );
	}
	...
	<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php if($title) echo esc_attr( $title ); else  '15AH, San Francisco,';?>" />
